...
// Overrides default behavior of grab interactable for arrow interactions
public class Arrow : XRGrabInteractable
{
    ...
    protected override void OnSelectEntering(SelectEnterEventArgs args)
    {
        ...
        {
            Clear();
            args.interactor.attachTransform.localPosition = Vector3.zero;
            args.interactor.attachTransform.localRotation = Quaternion.Euler(Vector3.zero);
        }

        // calls base xrtoolkit code  
